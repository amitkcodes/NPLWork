# Rate-limited alerts (1/hour/server).
# Log rotation (10 MB, 5 backups).
# Negative delay validation (logs warning, skips alerts).
# Thread pool (4 concurrent queries).Same 16 servers, no Data saved to ntp_data.csv in logs.
